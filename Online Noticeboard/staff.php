  ...
  <div class="row content">
    <div class="col-sm-3 sidenav">
      ...
      <ul class="nav nav-pills nav-stacked">
        <li class="active"><a href="staff.php">Today Notification</a></li>
        <li><a href="staffhistory.php">History</a></li>
        <li><a href="staffchpass.php">Change Password</a></li>
      ...
      <div class="row">
        <div class="col-sm-12">
          ...
          <?php
            ...
            $today=mysql_query("SELECT DateOfNotice FROM staff WHERE DateOfNotice='$dates'");
        ...
        //Number of rows
        $sql="SELECT * FROM staff WHERE DateOfNotice='$dates'";
       ...
       /* while ($row=mysql_fetch_array($result)) {
        ...
        //determine the sql LIMIT
         ...
         $sqls="SELECT * FROM staff WHERE DateOfNotice='$dates' LIMIT ".$this_page_first_result.','.$results_per_page;
