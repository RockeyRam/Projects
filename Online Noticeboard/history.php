...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="col-sm-9">
      <center><h2>History of All Notices</h2></center><br><br>
<br>      
      ...
      <?php
       ...
       /* while ($row=mysql_fetch_array($result)) {
        ...
        //determine the sql LIMIT
         ...
         $sqls="SELECT * FROM notice LIMIT ".$this_page_first_result.','.$results_per_page;
            ...
            <div class="col-sm-7">
              <div class="panel panel-primary">
                ...
                <div class="panel-body"><?php 
                    ...
                    if ($row['File']==true) {
                      # code...
                     //echo "<div class='modal fade' role='dialog' id='ram' >";
                    //  echo "<div class='modal-dialog'>";
                    //  echo "<div class='modal-content'>";
                      echo '<img height="100" width="100" id="model" src="data:image;base64,'.$row["File"].'"> ';
                      //echo "</div>";
                     /* echo "</div>";
                      echo "</div>";*/
                    }
        ...
        for ($page=1; $page<=$no_of_page ; $page++) { 
         ...
         <ul class="pagination"><?php
          echo '<li><a href="history.php?page='. $page.'">'.$page.'</a></li>';
          ?>
        </ul>
        <?php
        }
