  ...
  <div class="row content">
    <div class="col-sm-3 sidenav">
      ...
      <ul class="nav nav-pills nav-stacked">
        ...
        <li><a href="sudentallnotice.php">History</a></li>
        <li class="active"><a href="chpass.php">Change Password</a></li>
    ...
    <?php
      ...
      if (isset($sbtn)) {
        ...
        $qry=mysql_query("SELECT * FROM student WHERE RegNo='$RegNo'");
        ...
        if ($result['Password']==$old) {
          # code...
          $uqry=mysql_query("UPDATE student SET Password='$new' WHERE RegNo='$RegNo'");
          if ($uqry) {
            # code...
