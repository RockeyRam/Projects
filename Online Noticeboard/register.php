...
<html lang="en">
  ...
  <div class="row content">
    ...
    <center> <h2>Register Student</h2></center><br><br>
    <form method="Post">
      <div class="row">
        <div class="col-sm-6">
    ...
    <?php
      ...
      if (isset($add)) {
        ...
        if ($pass==$rpass) {
          # code...
          $iquery=mysql_query("INSERT INTO student(FirstName,LastName,DateOfBirth,RegNo,Course,Email,Password,PhoneNo,Address,City,State)VALUES('$fname','$lname','$dob','$regno','$course','$email','$pass','$cno','$addr','$city','$state')");
          if (!$iquery) {
            # code...
