...
//Validate the User Details
 function Validate($name,$email,$pass,$cpass)
 {
 	...
 	if ($pass==$cpass) 
 	{
 		...
 		$pass=md5($pass);
		$InsertUser=mysql_query("INSERT INTO Users(Name, Email, Password) VALUES ('$name','$email','$pass')");
		if (!$InsertUser) 
		{
		...
		{
			echo "<p>Your details successfully Registered</p>";
		}
	}
	else 
	{
